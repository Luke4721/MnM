  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black w-full relative z-10 transition-colors duration-500 pt-32 pb-24">
      ...
      <div className="fixed inset-0 pointer-events-none z-[-1] overflow-hidden">
        <div className="absolute top-[20%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-gradient-to-br from-[#D97736]/10 to-transparent blur-[120px] opacity-40 dark:opacity-20"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <motion.div 
          ...
          className="mb-8"
        >
          <Link to="/blog" className="inline-flex items-center gap-2 text-sm font-bold tracking-widest uppercase text-gray-500 hover:text-[#D97736] transition-colors">
        ...
        >
          <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-gray-500 dark:text-gray-400 mb-6 flex-wrap justify-center">
            <span className="flex items-center gap-1.5"><Calendar size={14} className="text-[#D97736]"/> {blog.date}</span>
            <span className="w-1 h-1 rounded-full bg-gray-300 dark:bg-gray-700"></span>
            <span className="flex items-center gap-1.5"><Clock size={14} className="text-[#D97736]"/> {blog.readTime}</span>
          </div>
        ...
        >
          ...
          <div className="hidden lg:flex flex-col gap-4 absolute -left-20 top-16 sticky-share">
            ...
            <button className="w-10 h-10 rounded-full bg-white dark:bg-zinc-800 shadow-md flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-[#D97736] hover:-translate-y-1 transition-all font-bold">
              f
            </button>
            <button className="w-10 h-10 rounded-full bg-white dark:bg-zinc-800 shadow-md flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-[#D97736] hover:-translate-y-1 transition-all font-bold">
              t
            ...
            <button className="w-10 h-10 rounded-full bg-white dark:bg-zinc-800 shadow-md flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-[#D97736] hover:-translate-y-1 transition-all mt-4">
              <Share2 size={18} />
            </button>
          </div>

          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-extrabold prose-a:text-[#D97736] prose-img:rounded-2xl" dangerouslySetInnerHTML={{ __html: blog.content }} />
